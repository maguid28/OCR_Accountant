...
public class NoSQLShowResultsDemoFragment extends DemoFragmentBase {
    private static final String LOG_TAG = com.mysampleapp.demo.nosql.NoSQLShowResultsDemoFragment.class.getSimpleName();

    /** The NoSQL Operation that was performed. */
    private static com.mysampleapp.demo.nosql.DemoNoSQLOperation noSQLOperation;
    ...
    public void setOperation(final com.mysampleapp.demo.nosql.DemoNoSQLOperation operation) {
