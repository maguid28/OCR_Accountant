...
public class DemoNoSQLTableFactory {
    /** Singleton instance. */
    private volatile static com.mysampleapp.demo.nosql.DemoNoSQLTableFactory instance;
    ...
    DemoNoSQLTableFactory(final Context context) {
        ...
        supportedTablesList.add(new DemoNoSQLTableReceiptData());
        for (final DemoNoSQLTableBase table : supportedTablesList) {
            supportedTablesMap.put(table.getTableName(), table);
        }
    }

    public synchronized static com.mysampleapp.demo.nosql.DemoNoSQLTableFactory instance(final Context context) {
        if (instance == null) {
            instance = new com.mysampleapp.demo.nosql.DemoNoSQLTableFactory(context);
        }
        return instance;
    }
