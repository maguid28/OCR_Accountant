package com.finalyearproject.dan.ocraccountingapp.amazon.user.signin;
//
...
public class CognitoUserPoolsSignInProvider implements SignInProvider {
    ...
    /** Resource ID of the Create Account button. */
    private static final int TEXT_VIEW_VERIFY_ACCOUNT_ID = R.id.signIn_textView_verifyAccount;
    ...
    public View.OnClickListener initializeSignInButton(final Activity signInActivity,
        ...
        activity.findViewById(TEXT_VIEW_FORGOT_PASSWORD_ID).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("usernameeditFORGOTPASSWORD: " + username);
        ...
        activity.findViewById(TEXT_VIEW_VERIFY_ACCOUNT_ID).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                username = ViewHelper.getStringValue(activity, EDIT_TEXT_USERNAME_ID);
                String[] temp = username.split("@");
        ...
        final View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("usernameedit: " + username);
